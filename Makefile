...
.PHONY: help check boundary validate-app-source-ref \
	compose-config compose-up compose-down print-app-source-ref \
...
check: boundary validate-app-source-ref terraform-fmt terraform-validate \
	raw-check observability-check compose-config helm-check
